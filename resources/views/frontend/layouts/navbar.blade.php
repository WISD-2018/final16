    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="{{route('商品資訊_查詢')}}" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">商品資訊</a>
                <!-- .dropdown-menu 下拉選單內容 -->
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <a class="dropdown-item" href="{{route('商品資訊_查詢')}}">商品資訊_查詢</a>
                    <a class="dropdown-item" href="{{route('商品資訊')}}">商品資訊</a>
                </div>
            </li>
